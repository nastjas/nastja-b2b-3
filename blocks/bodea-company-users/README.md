 ...
 * from Adobe.
 ****************************************************************** -->
# Bodea Company Users Block

## Overview

The Bodea Company Users block provides company user management functionality for B2B customers using the @dropins/storefront-company-management CompanyUsers container. It requires user authentication, company functionality to be enabled, and the customer to have an associated company. Users without these requirements are redirected to appropriate pages.
